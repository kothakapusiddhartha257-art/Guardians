# High-fidelity realistic .eml test fixtures for SIH demo and test verification

DEMO_BEC_EMAIL = """Received: from mail-relay.internal.acme.com (10.0.1.5) by mx.acme.com with ESMTP id m12345; Mon, 31 Aug 2026 10:22:02 +0000
...
DEMO_CREDENTIAL_PHISH_EMAIL = """Received: from inbound.acme.com (10.0.1.2) by mx.acme.com with ESMTP id p9876; Mon, 31 Aug 2026 09:15:00 +0000
...
DEMO_MALWARE_INVOICE_EMAIL = """Received: from mx.acme.com (10.0.1.1) by internal.acme.com id mal01; Mon, 31 Aug 2026 08:00:00 +0000
...
DEMO_CLEAN_FORWARDED_EMAIL = """Received: from mx.acme.com (10.0.1.1) by mailbox.acme.com id cln01; Mon, 31 Aug 2026 06:00:00 +0000
...
async def seed_demo_database():
    from backend.app.services.pipeline import execute_analysis_dag, ACTIVE_CASES_DB
    
    print("[*] Pre-seeding historical threat cases for signature correlation graph...")
    
    # 1. Seed 4 historical cases that share the same IP (185.23.11.4) and domain infrastructure
    historical_cases = [
        ("CASE-2026-00041", "Previous BEC Attempt on CFO", "Mon, 10 Aug 2026 09:00:00 +0000"),
        ("CASE-2026-00067", "Payroll Diversion Fraud Campaign", "Mon, 17 Aug 2026 14:30:00 +0000"),
        ("CASE-2026-00089", "Vendor Spoofing Incident", "Mon, 24 Aug 2026 11:15:00 +0000"),
        ("CASE-2026-00102", "Wire Transfer Impersonation", "Wed, 26 Aug 2026 16:45:00 +0000")
    ]
    
    for c_id, title, date_str in historical_cases:
        hist_eml = DEMO_BEC_EMAIL.replace("CASE-2026-00123", c_id).replace("Sarah Connor", f"Target {c_id}")
        await execute_analysis_dag(hist_eml.encode("utf-8"), case_id=c_id, actor="historical_seed")

    # 2. Seed clean email
    await execute_analysis_dag(DEMO_CLEAN_FORWARDED_EMAIL.encode("utf-8"), case_id="CASE-2026-00010", actor="analyst_01")
    
    print("[+] Historical cases seeded successfully. Graph correlation active.")
