/**
 * TRACEGUARD AI - In-Email DOM Injector
 * Mounts Shadow DOM threat banner and 400px slide-out forensic workspace.
 */

const WEB_APP_BASE = 'http://127.0.0.1:5173';
let activeSidePanel = null;

export function mountPanel(bundle, isAnalyzing, onScanTrigger) {
...
export function openForensicSidePanel(bundle) {
